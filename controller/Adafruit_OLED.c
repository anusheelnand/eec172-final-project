...
*  SPI.
*/
 GPIOPinWrite(GPIOA2_BASE, 0x2, 0); // CS
 GPIOPinWrite(GPIOA0_BASE, 0x8,0);  // DC
 SPITransfer(GSPI_BASE, &c, 0, 1, SPI_CS_ENABLE|SPI_CS_DISABLE);
 GPIOPinWrite(GPIOA2_BASE, 0x2, 0x2); // CS Back to high
...
*/
  ...
  SPITransfer(GSPI_BASE, &c, 0, 1, SPI_CS_ENABLE|SPI_CS_DISABLE);
  GPIOPinWrite(GPIOA2_BASE, 0x2, 0x2); // CS Enable
}
